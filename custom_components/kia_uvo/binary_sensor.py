...
SENSOR_DESCRIPTIONS: Final[tuple[HyundaiKiaBinarySensorEntityDescription, ...]] = (
    ...
    HyundaiKiaBinarySensorEntityDescription(
        key="tail_lamps_are_on",
        name="Tail Lamps",
        is_on=lambda vehicle: vehicle.tail_lamps_are_on,
        on_icon="mdi:car-light-dimmed",
        off_icon="mdi:car-light-dimmed",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    HyundaiKiaBinarySensorEntityDescription(
        key="hazard_lights_are_on",
        name="Hazard Lights",
        is_on=lambda vehicle: vehicle.hazard_lights_are_on,
        on_icon="mdi:car-light-alert",
        off_icon="mdi:car-light-alert",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    HyundaiKiaBinarySensorEntityDescription(
        key="is_locked",
