...
class HyundaiBlueLinkAPIUSA(KiaUvoApiImpl):
    ...
    def get_cached_vehicle_status(self, token: Token):
        ...
        vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureLampAll"] = vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureWarningLampAll"]
        vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureLampFL"] = vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureWarningLampFrontLeft"]
        vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureLampFR"] = vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureWarningLampFrontRight"]
        vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureLampRR"] = vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureWarningLampRearRight"]
        vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureLampRL"] = vehicle_status["vehicleStatus"]["tirePressureLamp"]["tirePressureWarningLampRearLeft"]
